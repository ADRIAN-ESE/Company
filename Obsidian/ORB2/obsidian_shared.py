...
ROLE_LEVEL = {"ceo": 6, "dg": 5, "admin": 4, "hr": 3, "manager": 2, "staff": 1}
ROLE_LABEL = {"ceo": "Chief Executive Officer", "dg": "Director General",
              "admin": "Admin", "hr": "HR Manager", "manager": "Manager", "staff": "Staff"}
...
ROLE_DEFINITIONS = {
    "ceo": {
        ...
        "icon":        "👑",
        "color":       "#f5c518",
        "purpose":     "Apex executive authority over the entire organisation. Sees all employees, all departments, all payroll, and all system activity across every division.",
        "responsibilities": [
            "Set and drive the strategic direction of the organisation",
            "Full read access across all departments, employees, and payroll",
            "Approve high-level structural changes and executive decisions",
            "Review organisation-wide audit logs and compliance reports",
            "Override and ratify any executive or HR decision",
        ],
        "level": 6,
    },
    "dg": {
        ...
        "icon":        "🎖️",
        "color":       "#c084fc",
        "purpose":     "Senior executive with cross-departmental authority. Full visibility across all people, operations, and financial data — second only to the CEO.",
        "responsibilities": [
            "Oversee and coordinate all departmental heads and their output",
            "Full read access to employee records, payroll, and audit logs",
            "Approve departmental budgets, headcount, and key initiatives",
            "Represent the CEO in executive meetings and reviews",
            "Monitor KPIs and escalate risks to the CEO",
        ],
        "level": 5,
    },
    "admin": {
...
def _defaults():
    ...
    return {
        "meta": {"last_emp_num": 0},
        "system_users": {
            "admin":      {"password_hash": hash_pw("admin123"),  "role": "admin",   "full_name": "System Administrator", "emp_id": None, "photo": None, "created": now, "department": None},
            "hr_manager": {"password_hash": hash_pw("hr123"),     "role": "hr",      "full_name": "HR Manager",           "emp_id": None, "photo": None, "created": now, "department": "Human Resources"},
            "manager1":   {"password_hash": hash_pw("mgr123"),    "role": "manager", "full_name": "Department Manager",   "emp_id": None, "photo": None, "created": now, "department": None},
            "staff1":     {"password_hash": hash_pw("staff123"),  "role": "staff",   "full_name": "Staff Member",         "emp_id": None, "photo": None, "created": now, "department": None},
        },
        "employees": {},
        "departments": {
